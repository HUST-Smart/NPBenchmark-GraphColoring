...
#ifndef SMART_SZX_GRAPH_COLORING_CSV_READER_H
#define SMART_SZX_GRAPH_COLORING_CSV_READER_H
...
#define SMART_SZX_GRAPH_COLORING_CSV_READER_RECURSIVE_VERSION  0
...
public:
    ...
    const std::vector<Row>& scan(std::ostringstream &oss) {
        ...
        #if SMART_SZX_GRAPH_COLORING_CSV_READER_RECURSIVE_VERSION
        onNewLine(begin);
        #else
        onNewLine_opt(begin);
        #endif // SMART_SZX_GRAPH_COLORING_CSV_READER_RECURSIVE_VERSION
...
#endif // SMART_SZX_GRAPH_COLORING_CSV_READER_H
